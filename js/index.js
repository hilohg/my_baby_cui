...
// 打字效果
var arr = [
    { type: 'text', text: '谢邀，我家宝宝，又名baby cui ，是个十足的老司机，嗯？' },
    { type: 'wait', time: 1000 },
    { type: 'delete', num: 6 },
    { type: 'text', text: '女神，嗯!' },
    { type: 'br' },
    ...
    { type: 'wait', time: 1000 },
    { type: 'img', src: 'img/girl.png', id: "cat", style: "width: 200px; height:200px; display: block;margin-left: auto;margin-right: auto;margin-top: 20px;margin-bottom: 20px;" },
    { type: 'wait', time: 1000 },
